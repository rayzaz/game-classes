// src/components/assistants/Merio/MerioQuestionnaire.tsx
  ...
  return (
    <div className="portal">
      ...
      {step === 1 && (
        <>
          <Hint>
            Имя! Пиши его прямо сейчас, и без глупостей. Возраст — от 13 до 15, это
            время, когда получаешь гримуар. Место рождения — Клевер, Алмаз, Пики или Червы…
            Если есть редкая родовая магия — укажи.
          </Hint>
      ...
      {step === 2 && (
        <>
          <Hint>
            Внешность: рост, вес, телосложение; волосы — цвет и длина; глаза; особые приметы.
          </Hint>
      ...
      {step === 7 && (
        <>
          <Hint>
            Бросаете куб, добавляете бонусы от класса/магии/предметов. Эффекты — отдельно. Побеждает больший результат.
          </Hint>
